...
<body style="background-size: cover;
    background-image: url(crime5.jpg);
    background-position: center;">
	<nav class="navbar navbar-default navbar-fixed-top" style="height: 60px;">
  <div class="container">
    <div class="navbar-header">

      <a class="navbar-brand" href="home.php" style="margin-top: 5%;"><b>Crime Solution</b></a>
    </div>
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Crime Solution by shaik sameer 2021</b></h4>
</div>
